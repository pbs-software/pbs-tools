...
if(getRversion() >= "2.15.1") utils::globalVariables(names=c(
	...
	"C1","C2","case","cast","cat440rec","catch","Cbar","Cbox","Ccat","ccol","cdata","Ceq","chn1","chn2","clara","clen","Clin","clwd","Cnum","cobs","coefficients","compo","Cpoi","cpuTime","cthin","ctot","Ctrd","currentMCMC","currentMSY","currentProj","currentProj2","Cval",
	...
	"obs","oma","orats","orfhistory","otoLith","out",
