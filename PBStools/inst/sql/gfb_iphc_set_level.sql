...
WHERE
  SURVEY_SERIES_ID = '14' AND FE_PARENT_EVENT_ID IS NULL
...
-- getData("gfb_iphc_set_level.sql", dbName="GFBioSQL", strSpp="435")
-- qu("gfb_iphc_set_level.sql", dbName="GFBioSQL", strSpp="394")
