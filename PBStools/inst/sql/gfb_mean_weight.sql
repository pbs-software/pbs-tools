...
WHERE
  (B21.TRIP_SUB_TYPE_CODE IN (1) OR B21.TRIP_SUB_TYPE_CODE BETWEEN 4 AND 14) AND
--  B21.TRIP_SUB_TYPE_CODE IN (2,3) AND
...
--YEAR(B21.TRIP_START_DATE) >= 2007 AND
  ...
  B22.SPECIMEN_SEX_CODE IN (1,2) AND
  B22.ROUND_WEIGHT IS NOT NULL
...
--qu("gfb_mean_weight.sql",dbName="GFBioSQL",strSpp="044",major=3:9)  -- DOG (241024) -- for Dee
