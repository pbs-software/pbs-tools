...
(SELECT
  ...
  (CASE
    ...
    WHEN CS.SFA_MSFA_MIDSIZE_FA_CDE IN (25,26,126,9250,9260) OR 
    ...
    WHEN CS.SFA_MSFA_MIDSIZE_FA_CDE IN (111,9110,9270) OR
    ...
    WHEN CS.SFA_MSFA_MIDSIZE_FA_CDE IN (8,9,108,109,110,9021,9070,9080,9090,9100) OR
        ...
        (CS.SFA_MSFA_MIDSIZE_FA_CDE IN (102) AND CS.SFA_SMALL_FA_CDE IN (0,3)) OR
    ...
    WHEN CS.SFA_MSFA_MIDSIZE_FA_CDE IN (6,106,9060) OR
        ...
        (CS.SFA_MSFA_MIDSIZE_FA_CDE IN (102) AND CS.SFA_SMALL_FA_CDE IN (2)) OR
