...
The initial reconstruction algorithm \citep{Haigh-Yamanaka:2011} used both \code{GFCatch} (logbook records, \citealt{Rutherford:1999}) and \code{PacHarv3} (sales slips) because it was assumed that the two databases should be recording the same landings.
...
As previously, the reconstruction of catch prior to 1950 used early records from 1918 to 1950 \citep{CDBS:1918-1950}.
